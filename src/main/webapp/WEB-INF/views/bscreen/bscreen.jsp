...
<link rel="stylesheet" href="${pageContext.request.contextPath}/media/css/bscreen/css/bscreen.css">
<script type="text/javascript" src="${pageContext.request.contextPath}/media/js/bscreen/js/jquery.js"></script>
<script>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/media/js/bscreen/js/echarts.min.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/media/js/bscreen/js/bscreen.js"></script>
<body>
	<div class="head">
	...
	<div class="mainbox">
		<ul class="clearfix">
			...
			<li>
				...
				<div class="map">
					<div class="map1">
						<img src="${pageContext.request.contextPath}/media/js/bscreen/picture/lbx.png">
					</div>
					<div class="map2">
						<img src="${pageContext.request.contextPath}/media/js/bscreen/picture/jt.png">
					</div>
					<div class="map3">
						<img src="${pageContext.request.contextPath}/media/js/bscreen/picture/map.png">
					</div>
					<div class="map4">
						<div style="height: 100%; width: 100%;">
