			...
			<div class="modal fade" aria-labelledby="keModalLabel"
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<!-- /.row -->
						<form role="form" action="${pageContext.request.contextPath}/system/user/add/" method="post"
			...
			<div class="modal fade" aria-labelledby="keModalLabel"
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<!-- /.row -->
						<form role="form" action="${pageContext.request.contextPath}/system/user/modify/" method="post"
			...
			<div class="modal fade" aria-labelledby="keUserModalLabel"
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<!-- /.row -->
						<form role="form" action="${pageContext.request.contextPath}/system/user/reset/" method="post"
