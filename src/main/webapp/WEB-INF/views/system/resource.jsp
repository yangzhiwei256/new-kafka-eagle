			...
			<div class="modal fade" aria-labelledby="keModalLabel"
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<!-- /.row -->
						<form role="form" action="${pageContext.request.contextPath}/system/resource/add/home/"
			...
			<div class="modal fade" aria-labelledby="keModalLabelChild"
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<!-- /.row -->
						<form role="form" action="${pageContext.request.contextPath}/system/resource/add/children/"
							method="post"
			...
			<div class="modal fade" aria-labelledby="keModalLabelDelete"
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<!-- /.row -->
						<form role="form"
							action="${pageContext.request.contextPath}/system/resource/delete/parent/or/children/"
							method="post"
