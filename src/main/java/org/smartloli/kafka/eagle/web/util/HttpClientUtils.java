...
public class HttpClientUtils {
    ...
    public static String doGet(String uri) {
        ...
        try {
            ...
            log.error("Do get request has error", e);
        } finally {
            try {
                if (response != null) {
                    response.close();
                ...
                log.error("Release get httpclient request has error", e);
            }
        }
        return result;
    }
    ...
    public static String doPostForm(String uri, List<BasicNameValuePair> parames) {
        ...
        try {
            ...
            log.error("Do post form request has error", e);
        } finally {
            try {
                if (response != null) {
                    response.close();
                ...
                log.error("Release post httpclient request has error", e);
            }
        }
        return result;
    }
    ...
    public static String doPostJson(String uri, String data) {
        ...
        try {
            ...
            log.error("Do post json request has error", e);
        } finally {
            try {
                if (response != null) {
                    response.close();
                ...
                log.error("Release post json request has error", e);
            }
        }
        return result;
    }
