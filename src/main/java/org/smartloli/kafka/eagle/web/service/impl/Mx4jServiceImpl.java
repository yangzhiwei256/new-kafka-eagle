	...
	private MBeanInfo common(String uri, String mbean) {
		...
		try {
			...
			if (mbeanConnection.isRegistered(new ObjectName(mbean))) {
				Object fifteenMinuteRate = mbeanConnection.getAttribute(new ObjectName(mbean), MBeanConstants.FIFTEEN_MINUTE_RATE);
				Object fiveMinuteRate = mbeanConnection.getAttribute(new ObjectName(mbean), MBeanConstants.FIVE_MINUTE_RATE);
				Object meanRate = mbeanConnection.getAttribute(new ObjectName(mbean), MBeanConstants.MEAN_RATE);
				Object oneMinuteRate = mbeanConnection.getAttribute(new ObjectName(mbean), MBeanConstants.ONE_MINUTE_RATE);
