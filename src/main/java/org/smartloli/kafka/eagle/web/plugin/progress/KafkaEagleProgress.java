 ...
 */
package org.smartloli.kafka.eagle.web.plugin.progress;
...
public class KafkaEagleProgress {
    ...
    public KafkaEagleProgress(int barLength, char showChar, String initMsg) {
        ...
        if (initMsg.equals("port")) {
            this.msg = "[" + DateUtils.getCustomDate(DATA_FORMAT_YEAN_MON_DAY_HOUR_MIN_SEC) + "] INFO: Port Progress: [";
        } else if (initMsg.equals("config")) {
            this.msg = "[" + DateUtils.getCustomDate(DATA_FORMAT_YEAN_MON_DAY_HOUR_MIN_SEC) + "] INFO: Config Progress: [";
        } else if (initMsg.equals("startup")) {
            this.msg = "[" + DateUtils.getCustomDate(DATA_FORMAT_YEAN_MON_DAY_HOUR_MIN_SEC) + "] INFO: Startup Progress: [";
        } else {
            this.msg = "[" + DateUtils.getCustomDate(DATA_FORMAT_YEAN_MON_DAY_HOUR_MIN_SEC) + "] INFO: Startup Progress: [";
        }
    }
