 ...
 */
package org.smartloli.kafka.eagle.web.sql.tool;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import org.smartloli.kafka.eagle.web.constant.JConstants;
...
public class JSqlUtils {
	...
	private static File createTempJson() throws IOException {
		...
		tmp.put("name", "db");
		tmp.put("type", "custom");
		tmp.put("factory", "org.smartloli.kafka.eagle.web.sql.schema.JSqlSchemaFactory");
