...
import org.smartloli.kafka.eagle.web.protocol.ZkClusterInfo;
...
public class ZKMetricsUtils {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(ZKMetricsUtils.class);
    ...
    public static ZkClusterInfo zkClusterMntrInfo(String ip, int port) {
        ...
        try {
            ...
            LOG.error("Socket[" + ip + ":" + port + "] connect refused", e);
            return zk;
        }
        ...
        try {
            ...
            while ((line = reader.readLine()) != null) {
                ...
                try {
                    ...
                    LOG.error("Split zookeeper metrics data has error", ex);
                }
            }
        } catch (Exception ex) {
