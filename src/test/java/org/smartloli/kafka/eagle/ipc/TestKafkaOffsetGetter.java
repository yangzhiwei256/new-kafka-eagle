...
import org.smartloli.kafka.eagle.web.protocol.offsets.KeyAndValueSchemasInfo;
import org.smartloli.kafka.eagle.web.protocol.offsets.MessageValueStructAndVersionInfo;
...
import org.smartloli.kafka.eagle.web.util.LRUCacheUtils;
...
public class TestKafkaOffsetGetter extends Thread {
    ...
    private final static String CONSUMER_OFFSET_TOPIC = KafkaConstants.CONSUMER_OFFSET_TOPIC;
	...
	/** ============================ Start Filter ========================= */
	private static final Schema OFFSET_COMMIT_KEY_SCHEMA_V0 = new Schema(new Field("group", Type.STRING), new Field("topic", Type.STRING), new Field("partition", Type.INT32));
	private static final BoundField KEY_GROUP_FIELD = OFFSET_COMMIT_KEY_SCHEMA_V0.get("group");
	private static final BoundField KEY_TOPIC_FIELD = OFFSET_COMMIT_KEY_SCHEMA_V0.get("topic");
	private static final BoundField KEY_PARTITION_FIELD = OFFSET_COMMIT_KEY_SCHEMA_V0.get("partition");
	...
	private static final BoundField VALUE_OFFSET_FIELD_V0 = OFFSET_COMMIT_VALUE_SCHEMA_V0.get("offset");
	private static final BoundField VALUE_METADATA_FIELD_V0 = OFFSET_COMMIT_VALUE_SCHEMA_V0.get("metadata");
	private static final BoundField VALUE_TIMESTAMP_FIELD_V0 = OFFSET_COMMIT_VALUE_SCHEMA_V0.get("timestamp");

	private static final BoundField VALUE_OFFSET_FIELD_V1 = OFFSET_COMMIT_VALUE_SCHEMA_V1.get("offset");
	private static final BoundField VALUE_METADATA_FIELD_V1 = OFFSET_COMMIT_VALUE_SCHEMA_V1.get("metadata");
	private static final BoundField VALUE_COMMIT_TIMESTAMP_FIELD_V1 = OFFSET_COMMIT_VALUE_SCHEMA_V1.get("commit_timestamp");
	...
	private static final BoundField VALUE_OFFSET_FIELD_V2 = OFFSET_COMMIT_VALUE_SCHEMA_V2.get("offset");
	private static final BoundField VALUE_METADATA_FIELD_V2 = OFFSET_COMMIT_VALUE_SCHEMA_V2.get("metadata");
	private static final BoundField VALUE_COMMIT_TIMESTAMP_FIELD_V2 = OFFSET_COMMIT_VALUE_SCHEMA_V2.get("commit_timestamp");

	private static final BoundField VALUE_OFFSET_FIELD_V3 = OFFSET_COMMIT_VALUE_SCHEMA_V3.get("offset");
	private static final BoundField VALUE_METADATA_FIELD_V3 = OFFSET_COMMIT_VALUE_SCHEMA_V3.get("metadata");
	private static final BoundField VALUE_COMMIT_TIMESTAMP_FIELD_V3 = OFFSET_COMMIT_VALUE_SCHEMA_V3.get("commit_timestamp");
	/** ============================ End Filter ========================= */

	/** Kafka offset memory in schema. */
	@SuppressWarnings("serial")
	private static final Map<Integer, KeyAndValueSchemasInfo> OFFSET_SCHEMAS = new HashMap<Integer, KeyAndValueSchemasInfo>() {
		{
	...
	public void run() {
        for (SingleClusterConfig singleClusterConfig : kafkaClustersConfig.getClusters()) {
            ...
            props.put(CommonClientConfigs.BOOTSTRAP_SERVERS_CONFIG, kafkaService.getKafkaBrokerServer(singleClusterConfig.getAlias()));
            props.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, StringDeserializer.class.getCanonicalName());
            props.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, StringDeserializer.class.getCanonicalName());
            if (singleClusterConfig.getSasl().getEnable()) {
                props.put(CommonClientConfigs.SECURITY_PROTOCOL_CONFIG, singleClusterConfig.getSasl().getProtocol());
                props.put(SaslConfigs.SASL_MECHANISM, singleClusterConfig.getSasl().getMechanism());
            }
            KafkaConsumer<String, String> consumer = new KafkaConsumer<>(props);
            startKafkaOffsetListener(singleClusterConfig.getAlias(), consumer);
        }
    }
