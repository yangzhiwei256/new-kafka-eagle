...
public class TestJGroupMetadataManager {
	...
	private static final short CURRENT_GROUP_KEY_SCHEMA_VERSION_V3 = 3;
	...
	private static final BoundField OFFSET_KEY_GROUP_FIELD = OFFSET_COMMIT_KEY_SCHEMA.get("group");
	private static final BoundField OFFSET_KEY_TOPIC_FIELD = OFFSET_COMMIT_KEY_SCHEMA.get("topic");
	private static final BoundField OFFSET_KEY_PARTITION_FIELD = OFFSET_COMMIT_KEY_SCHEMA.get("partition");
	...
	private static final BoundField OFFSET_VALUE_OFFSET_FIELD_V0 = OFFSET_COMMIT_VALUE_SCHEMA_V0.get("offset");
	private static final BoundField OFFSET_VALUE_METADATA_FIELD_V0 = OFFSET_COMMIT_VALUE_SCHEMA_V0.get("metadata");
	private static final BoundField OFFSET_VALUE_TIMESTAMP_FIELD_V0 = OFFSET_COMMIT_VALUE_SCHEMA_V0.get("timestamp");

	private static final Schema OFFSET_COMMIT_VALUE_SCHEMA_V1 = new Schema(new Field("offset", Type.INT64), new Field("metadata", Type.STRING, "Associated metadata.", ""), new Field("commit_timestamp", Type.INT64),
			new Field("expire_timestamp", Type.INT64));
	private static final BoundField OFFSET_VALUE_OFFSET_FIELD_V1 = OFFSET_COMMIT_VALUE_SCHEMA_V1.get("offset");
	private static final BoundField OFFSET_VALUE_METADATA_FIELD_V1 = OFFSET_COMMIT_VALUE_SCHEMA_V1.get("metadata");
	private static final BoundField OFFSET_VALUE_COMMIT_TIMESTAMP_FIELD_V1 = OFFSET_COMMIT_VALUE_SCHEMA_V1.get("commit_timestamp");
	private static final BoundField OFFSET_VALUE_EXPIRE_TIMESTAMP_FIELD_V1 = OFFSET_COMMIT_VALUE_SCHEMA_V1.get("expire_timestamp");
	...
	private static final BoundField OFFSET_VALUE_OFFSET_FIELD_V2 = OFFSET_COMMIT_VALUE_SCHEMA_V2.get("offset");
	private static final BoundField OFFSET_VALUE_METADATA_FIELD_V2 = OFFSET_COMMIT_VALUE_SCHEMA_V2.get("metadata");
	private static final BoundField OFFSET_VALUE_COMMIT_TIMESTAMP_FIELD_V2 = OFFSET_COMMIT_VALUE_SCHEMA_V2.get("commit_timestamp");

	private static final Schema OFFSET_COMMIT_VALUE_SCHEMA_V3 = new Schema(new Field("offset", Type.INT64), new Field("leader_epoch", Type.INT32), new Field("metadata", Type.STRING, "Associated metadata.", ""),
			new Field("commit_timestamp", Type.INT64));
	private static final BoundField OFFSET_VALUE_OFFSET_FIELD_V3 = OFFSET_COMMIT_VALUE_SCHEMA_V3.get("offset");
	private static final BoundField OFFSET_VALUE_LEADER_EPOCH_FIELD_V3 = OFFSET_COMMIT_VALUE_SCHEMA_V3.get("leader_epoch");
	private static final BoundField OFFSET_VALUE_METADATA_FIELD_V3 = OFFSET_COMMIT_VALUE_SCHEMA_V3.get("metadata");
	private static final BoundField OFFSET_VALUE_COMMIT_TIMESTAMP_FIELD_V3 = OFFSET_COMMIT_VALUE_SCHEMA_V3.get("commit_timestamp");

	private static final Schema GROUP_METADATA_KEY_SCHEMA = new Schema(new Field("group", Type.STRING));
	private static final BoundField GROUP_KEY_GROUP_FIELD = GROUP_METADATA_KEY_SCHEMA.get("group");
	...
	private static final Schema MEMBER_METADATA_V0 = new Schema(new Field(MEMBER_ID_KEY, Type.STRING), new Field(CLIENT_ID_KEY, Type.STRING), new Field(CLIENT_HOST_KEY, Type.STRING), new Field(SESSION_TIMEOUT_KEY, Type.INT32),
			new Field(SUBSCRIPTION_KEY, Type.BYTES), new Field(ASSIGNMENT_KEY, Type.BYTES));

	private static final Schema MEMBER_METADATA_V1 = new Schema(new Field(MEMBER_ID_KEY, Type.STRING), new Field(CLIENT_ID_KEY, Type.STRING), new Field(CLIENT_HOST_KEY, Type.STRING), new Field(REBALANCE_TIMEOUT_KEY, Type.INT32),
			new Field(SESSION_TIMEOUT_KEY, Type.INT32), new Field(SUBSCRIPTION_KEY, Type.BYTES), new Field(ASSIGNMENT_KEY, Type.BYTES));

	private static final Schema MEMBER_METADATA_V2 = MEMBER_METADATA_V1;

	private static final Schema MEMBER_METADATA_V3 = new Schema(new Field(MEMBER_ID_KEY, Type.STRING), new Field(GROUP_INSTANCE_ID_KEY, Type.NULLABLE_STRING), new Field(CLIENT_ID_KEY, Type.STRING), new Field(CLIENT_HOST_KEY, Type.STRING),
	...
	private static final Schema GROUP_METADATA_VALUE_SCHEMA_V0 = new Schema(new Field(PROTOCOL_TYPE_KEY, Type.STRING), new Field(GENERATION_KEY, Type.INT32), new Field(PROTOCOL_KEY, Type.NULLABLE_STRING),
			new Field(LEADER_KEY, Type.NULLABLE_STRING), new Field(MEMBERS_KEY, new ArrayOf(MEMBER_METADATA_V0)));

	private static final Schema GROUP_METADATA_VALUE_SCHEMA_V1 = new Schema(new Field(PROTOCOL_TYPE_KEY, Type.STRING), new Field(GENERATION_KEY, Type.INT32), new Field(PROTOCOL_KEY, Type.NULLABLE_STRING),
			new Field(LEADER_KEY, Type.NULLABLE_STRING), new Field(MEMBERS_KEY, new ArrayOf(MEMBER_METADATA_V1)));

	private static final Schema GROUP_METADATA_VALUE_SCHEMA_V2 = new Schema(new Field(PROTOCOL_TYPE_KEY, Type.STRING), new Field(GENERATION_KEY, Type.INT32), new Field(PROTOCOL_KEY, Type.NULLABLE_STRING),
	...
	private static final Schema GROUP_METADATA_VALUE_SCHEMA_V3 = new Schema(new Field(PROTOCOL_TYPE_KEY, Type.STRING), new Field(GENERATION_KEY, Type.INT32), new Field(PROTOCOL_KEY, Type.NULLABLE_STRING),
	...
	private static final Map<Integer, Schema> MESSAGE_TYPE_SCHEMAS = new HashMap<Integer, Schema>() {
		{
	...
	private static final Map<Integer, Schema> OFFSET_VALUE_SCHEMAS = new HashMap<Integer, Schema>() {
		{
	...
	private static final Map<Integer, Schema> GROUP_VALUE_SCHEMAS = new HashMap<Integer, Schema>() {
		{
	...
	private static final Schema CURRENT_OFFSET_KEY_SCHEMA = schemaForKey(CURRENT_OFFSET_KEY_SCHEMA_VERSION);
	private static final Schema CURRENT_GROUP_KEY_SCHEMA = schemaForKey(CURRENT_GROUP_KEY_SCHEMA_VERSION);
