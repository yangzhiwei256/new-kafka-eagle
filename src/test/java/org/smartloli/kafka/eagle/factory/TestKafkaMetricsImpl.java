...
import org.smartloli.kafka.eagle.web.service.impl.KafkaMetricsServiceImpl;
...
public class TestKafkaMetricsImpl {
	...
	private static final KafkaMetricsService kafkaMetric = new KafkaMetricsServiceImpl();
